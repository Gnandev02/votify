...
export default async function handler(req, res) {
    // Set JSON header explicitly just in case
    ...
    try {
        ...
        await pool.query(
            'INSERT INTO users (name, email, password, role, verified) VALUES ($1, $2, $3, $4, false)',
        ...
        try {
            ...
            // Rollback unverified user and otp entry so they can try again
